var menuState = {
    ...
    create: function ()
    {
        ...
        //On insère du texte
        game.add.text(20, 20, 'NinjaRunner', {font: '50px Arial', fill:'#FFFFFF'});
        game.add.text(20, game.world.height-410, 'Appuyer sur ENTRER pour commencer !', {font: '25px Arial', fill:'#FFFFFF'});
