...
function launchRandomObject()
{
    if (interframe > limiteInterframe && score < 2750)
    {
        ...
        if ((random % 3 == 0) && shuriken.x < 300 && pique.x < 300 && doublePique.x < 300 && enemy.x < 300)
        {
            if (randomNumberPique % 4 == 0)
            {
                launchDoublePique();
            }
            else
        ...
        else if ((random % 3 == 1) && shuriken.x < 300 && pique.x < 300 && doublePique.x < 300 && enemy.x < 300)
        {
        ...
        else if ((random % 3 == 2) && shuriken.x < 300 && pique.x < 300 && doublePique.x < 300 && enemy.x < 300)
        {
...
{
    doublePique = game.add.sprite(934, 445,'doublePique');
    ...
    doublePique.body.setSize(20, 62, 24, 5);
}
