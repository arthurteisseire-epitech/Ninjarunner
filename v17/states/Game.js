...
var gameState = {
    ...
    create: function ()
    {
        ...
        scoreText = game.add.text(16, 45, 'Score: 0', { fontSize: '26px', fill: '#FFFFFF' });
        meilleurscoreText = game.add.text(16, 16, 'Meilleur score: '+ meilleurScore, { fontSize: '26px', fill: '#FFFFFF' });
    ...
    update: function ()
    {
        ...
        if (mort == false)
        {
            ...
            changeBackground1(scoreToChangeBackground1, scoreToChangeBackground1 + 200);
            changeBackground2(scoreToChangeBackground2, scoreToChangeBackground2 + 200);
